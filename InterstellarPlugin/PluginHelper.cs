...
namespace InterstellarPlugin {
	...
	public class PluginHelper : MonoBehaviour {
        ...
        public static string getNewTechTreeFilePath() {
            return KSPUtil.ApplicationRootPath + "GameData/Interstellar/tree.cfg";
        }

        public static string getPluginSettingsFilePath() {
            return KSPUtil.ApplicationRootPath + "GameData/Interstellar/InterstellarSettings.cfg";
        }
		...
		public static void showInstallationErrorMessage() {
			if (!warning_displayed) {
				PopupDialog.SpawnPopupDialog ("KSP Interstellar Installation Error", "KSP Interstellar is unable to detect files required for proper functioning.  Please make sure that this mod has been installed to [Base KSP directory]/GameData/Interstellar.", "OK", false, HighLogic.Skin);
